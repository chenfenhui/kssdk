...
import com.haoxi.hzxb.utils.idsClass;
...
public class DemoHelper implements IIdentifierListener {
    ...
    public static final String ASSET_FILE_NAME_CERT = "com.haoxi.hzxb.cert.pem";  // TODO （2）设置 asset证书文件名
